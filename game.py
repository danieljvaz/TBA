...
class Game:
    ...
    def setup(self):
        ...
        forest = Room("Foret", "une forêt enchantée. Vous entendez une brise légère à travers la cime des arbres.")
        ...
        sky = Room("Sky", "un ciel sans fin.")
        self.rooms.append(sky)
        hole = Room("Hole", "un trou humide et profond.")
        self.rooms.append(hole)

        # Create exits for rooms

        forest.exits = {"N" : cave, "E" : None, "S" : castle, "O" : None, "U": sky, "D": None}
        ...
        swamp.exits = {"N" : tower, "E" : None, "S" : None, "O" : castle, "U": None, "D": hole}
        castle.exits = {"N" : forest, "E" : swamp, "S" : None, "O" : None, "U": None, "D": None}
        sky.exits = {"N" : None, "E" : None, "S" : None, "O" : None, "U": None, "D": forest}
        hole.exits = {"N" : None, "E" : None, "S" : None, "O" : cave, "U": swamp, "D": None}
        ...
        for room in self.rooms:
            self.player.directions.update(room.exits.keys())
